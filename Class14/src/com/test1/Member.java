...
//	记录敌人的坦克数据
	private static Vector<EnemyTank> entanks = new Vector<EnemyTank>();
//	记录我的坦克数据
	private static Vector<Hero> myTanks = new Vector<Hero>();
	
	public static Vector<EnemyTank> getEntanks() {
		return entanks;
	}
	public static void setEntanks(EnemyTank entank) {
		Recorder.entanks.add(entank);
	}
	public static Vector<Hero> getMyTanks() {
		return myTanks;
	}
	public static void setMyTanks(Hero hero) {
		Recorder.myTanks.add(hero);
	}
